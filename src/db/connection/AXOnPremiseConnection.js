...
const dbconfig = {
  ...
  connectString: process.env.AX_ONPREMISE_CONNECTSTRING,
  poolMax: 20,
  poolMin: 10,
  poolIncrement: 5,
  poolTimeout: 1,
...
module.exports = AXOnPremiseConnection;
